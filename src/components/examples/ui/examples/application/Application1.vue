...
import Card1 from '@/components/examples/ui/application/card/Card1'
import Card3 from '@/components/examples/ui/application/card/Card3'
import Card6 from '@/components/examples/ui/application/card/Card6'

// Demo menu content
import menu from '@/components/examples/ui/application/layout/menu'
